...
<body class="body">
    ...
    <header id = "top-nav-container">
        <div id = "logo-container">
            <img src="images/logo.png" alt="MedX Logo" id = "logo" src = "index.html">
        </div>
        <div id = "desktop-nav">
            <ul>
    ...
    <div class="banner home">
        ...
        <img src="images/medication-home.png" alt="Banner Image" class="order-header-image">
            ...
            <div class="carousel-background">
                <div class = "carousel-content store-carousel-content">
                    <div class = "carousel-slide multi-slide">
                        <div class="carousel-slide-content home-carousel-slide-content">
                            <div class = "product-image">
                                <img src="images/powder2.webp" alt="Product 1">
                            </div>
                            <div class = "Trending-product-text">
